...
@Composable
fun PdfReaderScreen(modifier: Modifier){
    ...
    val choosePdfLauncher = rememberLauncherForActivityResult(contract = ActivityResultContracts.GetContent()) { uri: Uri? ->
        pdfUri = uri
    }
            ...
            .drawWithContent {
                ...
                searchResults?.results?.forEach{ rect ->
                    ...
                    drawRoundRect(
                        ...
                        size = Size(
                            width = adjustRect.width(),
                            height = adjustRect.height()
                        ),
